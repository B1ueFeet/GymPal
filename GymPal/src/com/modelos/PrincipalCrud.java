...
public class PrincipalCrud {
	public static void main(String[] args)throws SQLException {
	    ...
	    System.out.println(pc.crear(produc1));
        System.out.println(pc.crear(produc2));
        System.out.println(pc.crear(produc3));
        System.out.println(pc.crear(produc4));
        System.out.println(pc.crear(produc5));

...
public class VUsuarios {
	...
	protected void createContents() {
		...
		lblNewLabel.setText("Ingrese Usuario y Contrasenia");
		...
		lblNewLabel_2.setText("Contrase̱a:");

		mostrarContrasenia = new Label(shell, SWT.NONE);
		mostrarContrasenia.setAlignment(SWT.RIGHT);
		mostrarContrasenia.setBounds(360, 161, 118, 15);
		mostrarContrasenia.setText("Mostrar Contrasenia");
	...
	public void setControlador(ControlEmpleados c) {
		...
		mostrarContrasenia.addListener(SWT.TRAVERSE_RETURN, c);
